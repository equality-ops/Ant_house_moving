...
# 创建视觉伺服管理对象2
my_vision_manager_2 = ant_plan.VisionManager_2(my_flash_sys, my_car, my_plan, servo_pid_x, servo_pid_y, servo_yaw_fil)
...
def test_odometer():
    ...
    global count
    if count == 0:
        if my_car.y_current <= 50.0 and test_stage == 0:
