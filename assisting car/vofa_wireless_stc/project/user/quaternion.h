...
extern Kalman1D kf_gx, kf_gy, kf_gz;//陀螺仪卡尔曼滤波器
// 初始化卡尔曼滤波器
...
// dq计算
extern void omega_to_dq(float wx, float wy, float wz, float dt, Quat *dq);

// 四元数乘法
extern void quat_mul(const Quat *q1, const Quat *q2, Quat *out);

// 归一化
extern void quat_normalize(Quat *q);

// 转欧拉角
extern void quat_to_euler(const Quat *q, float *roll, float *pitch, float *yaw);
