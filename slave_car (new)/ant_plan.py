...
class Plan_data:
    def __init__(self, flash_sys):
        ...
        self.fixed_point = [[30.0, -15.0], [110.0, 50.0], [210.0, 190.0], [210.0, 50.0], [110.0, 190.0], [160.0, 20.0], [160.0, 220.0]]  # type: list
        # 矩形区域四角点坐标
    ...
    def set_target_point(self, x: float, y: float):
        ...
        if self.my_state.state != self.my_state.MOVE:
            ...
            if y_transit_dis >= 50.0:
                self.my_car.alpha_y = 0.967011
            elif y_transit_dis >= 10.0:
                self.my_car.alpha_y = 0.923345
            else:
        ...
        # 中距离移动
        elif total_distance >= 15.0 and total_distance < 50.0:
            # 设置减速距离和加速时间阈值
            self.dec_distance = 14.0
